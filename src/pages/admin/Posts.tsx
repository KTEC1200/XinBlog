...
export function AdminPosts() {
  ...
  // AI 面板滚动的根本修复：React 的 onWheel 是 passive 监听，无法 preventDefault，
  // 所以滚轮会穿透到背景编辑器。这里挂载原生非被动 wheel 监听：
  // - 鼠标在内部滚动区：内部可滚就正常滚，到边界才阻止默认行为（杜绝穿透）；
  // - 鼠标在面板头部/底部操作区：直接阻止默认行为，背景绝不动。
  useEffect(() => {
